<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WebQuanAo.login" %>
    ...
    <header class="header">
        ...
        <nav class="nav container">
            ...
            <div class="header__user-actions">
                ...
                <div id="loginn"  runat="server"></div>
            ...
            <div class="login-register__container container grid">
                <div class="login" id="form-login">
                    <div class="login__title">
                        ...
                        <a href="register.aspx" class="section__title" style="color:black">Register</a>
                    </div>
                    

                    <form action="" class="form grid" method="post" runat="server" onsubmit="return btnSign()">
                        <input
                            type="text"
                            name="username"
                            id="txtUsername"
                        ...
                        <div class="form__btn" id ="btnLogg" runat="server">
                            <button type="submit" onclick="btnSign()" class="btn" runat="server" id="btnLog">Login</button>
                        </div>
